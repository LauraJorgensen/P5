...
# --- Inddel test og training set på 15 min ---
...
# --- LRT ---
exog_variables_to_test = ['cloud_cover', 'temperature', 'direct_radiation', 'diffuse_radiation', 'cloudcover_low', 'cloudcover_mid', 'cloudcover_high']
...
for var in exog_variables_to_test:
    ...
    for h in range(24):
        ...
        lrt_results_by_var[var][h] = {'ll_null': ll_null,'ll_alt': ll_alt,'lr_stat': lr_stat,'p_value': p_value,'significant': p_value < 0.05}
...
# --- Remove hours 0,1,2,20,21,22,23 ---
...
sns.heatmap(p_value_matrix_filtered, xticklabels=hours_to_plot, yticklabels=exog_variables_to_test,cmap='RdBu_r', vmin=0, vmax=0.1,  annot=True, fmt='.2f',cbar_kws={'label': '$p$-value'},linewidths=0.5)
plt.xlabel('Hour')
